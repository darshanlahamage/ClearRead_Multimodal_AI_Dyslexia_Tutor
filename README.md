...
This solution revolves around the concept of a **"Multimodal Learning Loop."** We use the **Amazon Nova 2** family of models not as isolated features, but as a cohesive intelligence layer that tracks a student across three distinct learning modes.
...
### 3. Contextual Personalization (Multimodal Vision)
- **The Scene Loop**: Leverages Nova 2 Lite Vision to synthesize context.
- **The Integration**: The Vision context is fed into the Interactive Practice mode, allowing "Coach Nova" to have a naturally grounded conversation about the image the student just captured.
